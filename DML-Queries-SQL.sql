...
# Oprettelse af inner join med specificering efter dato interval.
# Først 4 linjer er samme som før nævnt.
# <where reg_date >"2019-04-20"> betyder at vi ønsker at se personer som har registreret sig efter 20 april 2019
# <order by reg_date desc> betyder at vi sorterer rækkefølgen med sidste oprettet øverst
select r.user_id, u.email, u.reg_date, u.first_name, u.last_name, r.Development_result, r.Digital_Marketing_result, r.creative_result
From Users u
inner join Results r
on u.user_id = r.user_id;
where reg_date >"2019-04-20"
